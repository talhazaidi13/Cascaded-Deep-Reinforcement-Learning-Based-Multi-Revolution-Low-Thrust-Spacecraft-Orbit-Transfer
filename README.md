...
:-: | :-:
<![CDRL based GTO to GEO transfer](/paper-outputs/GTO-GEO.gif) width=100/> | <![CDRL based GTO to GEO transfer](/paper-outputs/GTO-GEO.gif) width=100/>


![CDRL based GTO to GEO transfer](/paper-outputs/GTO-GEO.gif)
